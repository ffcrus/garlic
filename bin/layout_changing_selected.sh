...
## Обрабарываем ситуацию, когда пользователь не успел отпустить клавишу Insert. Или когда она нажата по каким-то другим причинам.
xdotool keyup Insert
## Вызываем комбинацию клавиш, копирующих выделенный текст, отключая на время действия модификаторов (Ctrl, Alt, Shift, etc)
